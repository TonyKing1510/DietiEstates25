...
import com.example.prova2.requester.CheckPasswordRequester;
...
public class CambioPasswordController {
    ...
    private static boolean isPasswordVecchiaValida(String password) {
        return CheckPasswordRequester.checkPassword(DashboardAmministratoreController.getAdmin(), password);
    }
