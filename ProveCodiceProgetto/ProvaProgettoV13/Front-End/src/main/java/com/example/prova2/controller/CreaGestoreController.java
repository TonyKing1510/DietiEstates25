...
public class CreaGestoreController {
    ...
    public static Alert generateSuccessMessage(){
        return AlertFactory.generateAlertSuccess("Torna alla dashboard","Continua a creare altri gestori");
    }
    ...
    public boolean checkUsername(){
        ...
        attivaMessaggioMinimoCaratteri(username,6,lunghezzaUsername);
    ...
    public boolean checkPassword() {
        ...
        attivaMessaggioMinimoCaratteri(password,8,lunghezzaPass);
