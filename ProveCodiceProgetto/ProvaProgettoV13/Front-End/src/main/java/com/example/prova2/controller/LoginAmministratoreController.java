...
public class LoginAmministratoreController {
    ...
    private void inviaDati(){
        ...
        gestisciLogin(loginAdminRequester,gestoreAgenziaImmobiliare);
    }
    ...
    private void gestisciLogin(LoginAdminRequester loginAdminRequester, GestoreAgenziaImmobiliare g){
        if(isAndatoTuttoBene(loginAdminRequester,g)) {
    ...
    private static boolean isAndatoTuttoBene(LoginAdminRequester loginAdminRequester,GestoreAgenziaImmobiliare g){
        return loginAdminRequester.effettuaLoginAdmin(g);
    }
