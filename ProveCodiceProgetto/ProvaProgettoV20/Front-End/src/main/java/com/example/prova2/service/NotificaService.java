...
public class NotificaService {
    ...
    public static List<Notifica> getNotificationsForAdmin(String cf) throws IOException, InterruptedException {
        ...
        return getNotifiche(baseUrl);
    }

    public static List<Notifica> getNotificationsForAgente(String cf) throws IOException, InterruptedException {
        String baseUrl="http://localhost:9094/not/agente?cf="+cf;
        return getNotifiche(baseUrl);
    }

    private static List<Notifica> getNotifiche(String baseUrl) throws IOException, InterruptedException {
