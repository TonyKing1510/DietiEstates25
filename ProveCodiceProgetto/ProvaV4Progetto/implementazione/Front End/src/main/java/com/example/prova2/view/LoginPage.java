...
public class LoginPage extends Application {
    ...
    public void startMainApp(Stage primaryStage) throws IOException {
        ...
        // Trova il pulsante "Sign In" dalla scena
        Button signInButton = (Button) scene.lookup("#signInButton");  // Assicurati di usare l'ID corretto del pulsante Sign In
        signInButton.setOnAction(e -> {
            try {
                // Quando l'utente clicca "Sign In", mostra il caricamento
                HomePage.caricamentoHome(primaryStage); // Aggiungi questa riga per avviare il video di caricamento
