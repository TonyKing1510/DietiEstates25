...
public class GestoreAgenziaImmobiliareDTO {
    ...
    @JsonProperty("primoaccesso")
    private boolean fattoPrimoAccesso;

    public boolean isFattoPrimoAccesso() {
        return fattoPrimoAccesso;
    }

    public void setFattoPrimoAccesso(boolean fattoPrimoAccesso) {
        this.fattoPrimoAccesso = fattoPrimoAccesso;
    }
