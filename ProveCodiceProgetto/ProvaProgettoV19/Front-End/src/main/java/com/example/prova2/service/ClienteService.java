...
public class ClienteService {
    ...
    private static String queryRegistrati = """
                {
    ...
    private static String url = "http://localhost:9094/cliente/add";
    ...
    public static String buildString(Cliente c) {
        return String.format("""
                        ...
                        """,
                c.getAccountCliente().getMail(),
                c.getAccountCliente().getPassword(),
                c.getNome(),
                c.getCognome(),
                c.getTelefono());
    }
