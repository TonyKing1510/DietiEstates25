...
public class AnnunciFactory {
    ...
    private static final String STILEPANEANNUNCI = "-fx-background-color : rgba(1, 22, 56, 0.2);";
    ...
    public static Pane createPaneInfoDescrizione(String descrizione){
        Pane pane = new Pane();
        pane.setStyle(STILEPANE);
        pane.setPrefSize(370, 120);
        pane.setLayoutX(13);
        pane.setLayoutY(331);
        Label label = new Label(descrizione);
        label.setStyle(STILEFONTFORNITURE);
        label.setPrefSize(350,82);
    ...
    public static HBox createHboxAnnunciAgente(String indice,String titolo,String tipologia, String citta){
        HBox hbox = HBoxFactory.createHboxAnnunci();

        Pane pane = new Pane();
        pane.setPrefSize(199,42);
        Pane pane1 = new Pane();
        ...
        Label label1 = new Label(tipologia);
        label1.setLayoutX(5);
        label1.setStyle(STILEFONTANNUNCIAGENTE);
