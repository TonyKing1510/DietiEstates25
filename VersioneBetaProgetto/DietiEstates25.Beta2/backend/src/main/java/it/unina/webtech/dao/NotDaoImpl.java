...
public class NotDaoImpl implements NotDao {
    ...
    public List<Notifica> getNotofAdmin(String cf) {
        return getNotifiche("gestoreNotificato", cf);
    }

    @Override
    public List<Notifica> getNotificaAgente(String cf) {
        return getNotifiche("agenteNotificato", cf);
    }

    @Override
    public List<Notifica> getNotificaCliente(String email) {
        return getNotifiche("clienteNotificato", email);
    }
    ...
    private List<Notifica> getNotifiche(String colonna, String valore) {
        ...
        String query = "SELECT titolo, contenuto, id_notifica, categoria, id_immobile FROM notifica WHERE " + colonna + " = ? AND accettata IS NULL AND da_inviare = true";
